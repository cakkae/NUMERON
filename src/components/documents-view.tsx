...
export function DocumentsView(props: {
  ...
  async function rejectDocument() {
    ...
    try {
      ...
      setSelected(null); setSignedUrl(""); await props.onRefresh();
